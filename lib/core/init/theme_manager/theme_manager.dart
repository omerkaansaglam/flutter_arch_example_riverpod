...
import 'package:flutter_arch_example_riverpod/ui/shared/styles/colors.dart';
...
class ThemeManager extends ChangeNotifier implements _IThemeManager {
  ...
  @override
  EdgeInsets get normalHorizontalPagePadding => EdgeInsets.symmetric(horizontal: mediumValue);
