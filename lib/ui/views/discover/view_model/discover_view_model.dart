...
import 'package:flutter_arch_example_riverpod/ui/views/discover/service/discover_service.dart';
...
final discoverViewModelProvider = StateNotifierProvider.autoDispose<DiscoverViewModel, List<MovieItem>>((ref) => DiscoverViewModel(ref: ref));

final discoverFutureProvider = FutureProvider.autoDispose<List<MovieItem>>((ref) async {
  final response = await ref.read(discoverViewModelProvider.notifier).getTrendingVideos();
