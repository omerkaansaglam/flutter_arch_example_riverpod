...
import 'package:flutter_arch_example_riverpod/core/init/theme_manager/theme_manager.dart';
  ...
  ThemeData customThemeData() {
    ...
    return ThemeData(
      ...
      textTheme: GoogleFonts.poppinsTextTheme()
          .apply(displayColor: themeManager.dark, bodyColor: themeManager.dark,),
    );
  }
}
